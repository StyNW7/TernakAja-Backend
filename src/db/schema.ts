...
export const livestockDetailsTable = pgTable('livestock_details', {
  id: serial('id').primaryKey(),
  livestockId: integer('livestock_id').notNull().references(() => livestockTable.id),
  height: real('height'),
  weight: real('weight'),
...
export const marketplaceTable = pgTable('marketplace', {
  ...
  userId: integer('user_id').notNull().references(() => usersTable.id),
  livestockId: integer('livestock_id').notNull().references(() => livestockTable.id),
  categoryId: integer('category_id').references(() => marketplaceCategoriesTable.id),
  title: text('title'),
...
export const marketplacePhotosTable = pgTable('marketplace_photos', {
  id: serial('id').primaryKey(),
  marketplaceId: integer('marketplace_id').notNull().references(() => marketplaceTable.id),
